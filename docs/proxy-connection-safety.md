...
- The app cancels local command, automation, recording and picker work, terminates managed agents/terminals, and stops the affected browser. If cleanup fails, no replacement browser is launched.
