...
- برای گفت‌وگو با جامعه، دریافت راهنمایی راه‌اندازی و دنبال‌کردن به‌روزرسانی‌های محصول به [Discord نکست‌براوزر](https://discord.com/invite/gHXEvkGXnz) بپیوندید.
...
تحت مجوز **GNU AGPL-3.0** توزیع می‌شود. متن کامل: [GNU AGPL-3.0](../../../LICENSE).
