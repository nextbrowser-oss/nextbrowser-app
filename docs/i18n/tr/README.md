...
- Topluluk sohbeti, kurulum yardımı ve ürün güncellemeleri için [Nextbrowser Discord](https://discord.com/invite/gHXEvkGXnz) sunucusuna katılın.
...
**GNU AGPL-3.0** lisansı altında dağıtılır. Tam metin: [GNU AGPL-3.0](../../../LICENSE).
