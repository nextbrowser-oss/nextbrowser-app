...
- Dołącz do [Discorda Nextbrowser](https://discord.com/invite/gHXEvkGXnz), aby rozmawiać ze społecznością, uzyskać pomoc w konfiguracji i śledzić aktualizacje produktu.
...
Udostępniane na licencji **GNU AGPL-3.0**. Pełny tekst: [GNU AGPL-3.0](../../../LICENSE).
