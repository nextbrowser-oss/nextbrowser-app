...
- Приєднуйтеся до [Discord Nextbrowser](https://discord.com/invite/gHXEvkGXnz) для спілкування зі спільнотою, допомоги з налаштуванням і новин продукту.
...
Поширюється за ліцензією **GNU AGPL-3.0**. Повний текст: [GNU AGPL-3.0](../../../LICENSE).
