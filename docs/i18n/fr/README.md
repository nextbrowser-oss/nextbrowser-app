...
- Rejoignez le [Discord Nextbrowser](https://discord.com/invite/gHXEvkGXnz) pour échanger avec la communauté, obtenir de l’aide à la configuration et suivre les actualités du produit.
...
Distribué sous licence **GNU AGPL-3.0**. Texte intégral : [GNU AGPL-3.0](../../../LICENSE).
