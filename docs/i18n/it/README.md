...
- Unisciti al [Discord di Nextbrowser](https://discord.com/invite/gHXEvkGXnz) per parlare con la community, ricevere assistenza per la configurazione e seguire gli aggiornamenti del prodotto.
...
Distribuito con licenza **GNU AGPL-3.0**. Testo completo: [GNU AGPL-3.0](../../../LICENSE).
