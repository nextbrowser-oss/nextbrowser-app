...
- Únete al [Discord de Nextbrowser](https://discord.com/invite/gHXEvkGXnz) para conversar con la comunidad, obtener ayuda con la configuración y recibir novedades del producto.
...
Distribuido bajo la licencia **GNU AGPL-3.0**. Texto completo: [GNU AGPL-3.0](../../../LICENSE).
