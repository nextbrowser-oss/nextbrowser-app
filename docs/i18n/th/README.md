...
- เข้าร่วม [Discord ของ Nextbrowser](https://discord.com/invite/gHXEvkGXnz) เพื่อพูดคุยกับชุมชน รับความช่วยเหลือในการตั้งค่า และติดตามอัปเดตผลิตภัณฑ์
...
เผยแพร่ภายใต้สัญญาอนุญาต **GNU AGPL-3.0** ข้อความฉบับเต็ม: [GNU AGPL-3.0](../../../LICENSE)
