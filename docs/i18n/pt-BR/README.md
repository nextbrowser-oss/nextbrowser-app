...
- Entre no [Discord do Nextbrowser](https://discord.com/invite/gHXEvkGXnz) para conversar com a comunidade, obter ajuda de configuração e acompanhar novidades do produto.
...
Distribuído sob a licença **GNU AGPL-3.0**. Texto completo: [GNU AGPL-3.0](../../../LICENSE).
