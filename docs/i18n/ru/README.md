...
- Присоединяйтесь к [Discord Nextbrowser](https://discord.com/invite/gHXEvkGXnz) для общения с сообществом, помощи с настройкой и новостей продукта.
...
Распространяется по лицензии **GNU AGPL-3.0**. Полный текст: [GNU AGPL-3.0](../../../LICENSE).
