...
- انضم إلى [Discord الخاص بـ Nextbrowser](https://discord.com/invite/gHXEvkGXnz) للتواصل مع المجتمع والحصول على مساعدة في الإعداد ومتابعة تحديثات المنتج.
...
يُوزَّع بموجب ترخيص **GNU AGPL-3.0**. النص الكامل: [GNU AGPL-3.0](../../../LICENSE).
