...
- समुदाय से बातचीत, सेटअप सहायता और उत्पाद अपडेट के लिए [Nextbrowser Discord](https://discord.com/invite/gHXEvkGXnz) से जुड़ें।
...
**GNU AGPL-3.0** लाइसेंस के अंतर्गत वितरित। पूरा पाठ: [GNU AGPL-3.0](../../../LICENSE)।
