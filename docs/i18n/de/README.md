...
- Tritt dem [Nextbrowser Discord](https://discord.com/invite/gHXEvkGXnz) bei, um dich mit der Community auszutauschen, Hilfe bei der Einrichtung zu erhalten und Produktneuigkeiten zu verfolgen.
...
Veröffentlicht unter der **GNU AGPL-3.0**-Lizenz. Vollständiger Text: [GNU AGPL-3.0](../../../LICENSE).
