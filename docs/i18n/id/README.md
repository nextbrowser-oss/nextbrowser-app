...
- Bergabunglah dengan [Discord Nextbrowser](https://discord.com/invite/gHXEvkGXnz) untuk berdiskusi dengan komunitas, mendapatkan bantuan penyiapan, dan mengikuti pembaruan produk.
...
Didistribusikan di bawah lisensi **GNU AGPL-3.0**. Teks lengkap: [GNU AGPL-3.0](../../../LICENSE).
