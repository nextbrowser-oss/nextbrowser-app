...
- Word lid van de [Nextbrowser Discord](https://discord.com/invite/gHXEvkGXnz) voor gesprekken met de community, hulp bij de installatie en productupdates.
...
Gedistribueerd onder de **GNU AGPL-3.0**-licentie. Volledige tekst: [GNU AGPL-3.0](../../../LICENSE).
