...
- [Nextbrowser Discord](https://discord.com/invite/gHXEvkGXnz) に参加して、コミュニティ交流、セットアップのサポート、製品の最新情報を確認してください。
...
**GNU AGPL-3.0** ライセンスの下で配布されています。全文：[GNU AGPL-3.0](../../../LICENSE)。
